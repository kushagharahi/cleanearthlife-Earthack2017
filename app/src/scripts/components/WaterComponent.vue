<template>
	<div>
	<i class="fa fa-shower" aria-hidden="true" style="font-size: 10em;"></i>
		...
		<p>If you showered <input v-model="minutes" style="width: 30px;" maxlength="2"/> minutes less a day, you would save <b>{{waterSaved}} gallons</b> a shower.</p>
