...
var map = {
	...
	"./MeatComponent.vue": 57,
	"./NavComponent.vue": 12,
	"./PlasticBottleComponent.vue": 58,
	"./PledgeComponent.vue": 59,
	"./PollutionComponent.vue": 60,
	"./ShareComponent.vue": 83,
	"./WaterComponent.vue": 61,
...
Component.options.__file = "C:\\Users\\rkark\\Documents\\Projects\\JavaLoginTemplate\\LoginProject\\app\\src\\scripts\\components\\MeatComponent.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "C:\\Users\\rkark\\Documents\\Projects\\JavaLoginTemplate\\LoginProject\\app\\src\\scripts\\components\\PlasticBottleComponent.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "C:\\Users\\rkark\\Documents\\Projects\\JavaLoginTemplate\\LoginProject\\app\\src\\scripts\\components\\PledgeComponent.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__WaterComponent_vue__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__PollutionComponent_vue__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__PlasticBottleComponent_vue__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__MeatComponent_vue__ = __webpack_require__(57);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__PledgeComponent_vue__ = __webpack_require__(59);
...
Component.options.__file = "C:\\Users\\rkark\\Documents\\Projects\\JavaLoginTemplate\\LoginProject\\app\\src\\scripts\\components\\ShareComponent.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('p', [_vm._v("Methane from cattle waste accounts for "), _c('b', [_vm._v("14.5")]), _vm._v(" and "), _c('b', [_vm._v("18")]), _vm._v(" percent of the total greenhouse gas emissions")])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _c('h1', [_vm._v("CleanEarth.Life - A little change goes far")]), _vm._v(" "), _c('h4', [_vm._v("So far, " + _vm._s(_vm.fbData.usersPledged) + " people have pledged to:")]), _vm._v(" "), _c('p', [_vm._v("Using " + _vm._s((_vm.fbData.showerMinutes * 2.1).toFixed(1)) + " gallons less when showering per day!")]), _vm._v(" "), _c('p', [_vm._v("Reducing car pollution by " + _vm._s((_vm.fbData.milesReduced / 25 * 19.5).toFixed(1)) + " pounds!")]), _vm._v(" "), _c('p', [_vm._v("Saving $" + _vm._s(_vm.fbData.lightReplace * 100) + " a year on energy!")]), _vm._v(" "), _c('p', [_vm._v("Using " + _vm._s(_vm.fbData.bottlesReduced) + " less disposible plastic bottles per week!")]), _vm._v(" "), _c('p', [_vm._v("Reducing methane emissions by " + _vm._s((540 * 250 * (.5 / 1000) * _vm.fbData.meatReduced).toFixed(1)) + " liters a day!")]), _vm._v(" "), _c('br'), _vm._v(" "), _c('p', [_vm._v("Want to get involved? Scroll down!")])])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
